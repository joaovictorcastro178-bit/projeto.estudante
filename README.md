...
* ❌ Não permite lutas entre categorias diferentes
* ✔️ Apenas lutas válidas são simuladas
* 🎲 Resultados são sempre aleatórios
...
* Simular cenários reais de forma simplificada
...
* Sistema de ranking
* Histórico de lutas
* Probabilidades baseadas em atributos dos lutadores
